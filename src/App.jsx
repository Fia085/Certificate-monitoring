...
// NOTE: this demo persists data in the browser's localStorage, so data is
// per-browser only (not shared between users/devices). For a real multi-user
// system, replace this hook with calls to a real backend + database.
